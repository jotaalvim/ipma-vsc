...
var baseStorage = path.join(os.homedir(), ".ipma-carta-images");
var storageDir = path.join(baseStorage, "ipma-cartas");
var outputVideoNameMp4 = "weather_output.mp4";
var videoMaxAgeMs = 20 * 60 * 60 * 1e3;
...
async function convertFramesToMp4(dataDir, runId) {
...
function removeOldPhotos(dataDir) {
...
function isVideoFresh(videoPath) {
...
async function reloadIpmaData(showCompletionMessage) {
        ...
        <script>
            ...
            const loadTemperatureData = async () => {
                ...
                try {
                    ...
                    cachedUnit = payload?.hourly_units?.temperature_2m || '\xB0C';
